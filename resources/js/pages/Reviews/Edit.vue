    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 rounded-xl p-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-semibold text-foreground">Edit Review</h1>
                    <p class="text-sm text-muted-foreground">Update review information</p>
                </div>
            </div>
                ...
                <CardContent>
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <Button variant="outline" type="button" @click="$inertia.visit(route('reviews.show', review.id))">
                                Cancel
                            </Button>
                        </div>
                    </form>
